...
```
[link](https://github.github.com/url "title")
[link](https://github.github.com/url 'title')
[link](https://github.github.com/url (title))
...
```
[link](https://github.github.com/url "title "and" title")

```


```
<p>[link](https://github.github.com/url &quot;title &quot;and&quot; title&quot;)</p>
...
```
[link *foo **bar** `#`*](https://github.github.com/uri)
...
```
<p>[foo <a href="/uri">bar</a>](https://github.github.com/uri)</p>

```


```
[foo *[bar [baz](https://github.github.com/uri)](/uri)*](/uri)

```


```
<p>[foo <em>[bar <a href="/uri">baz</a>](https://github.github.com/uri)</em>](/uri)</p>
...
```
<p>[foo<code>](https://github.github.com/uri)</code></p>
...
```
[foo [bar](https://github.github.com/uri)][ref]
...
```
![foo ![bar](https://github.github.com/url)](/url2)
...
Though this spec is concerned with parsing, not rendering, it is recommended that in rendering to HTML, only the plain string content of the [image description](#image-description) be used. Note that in the above example, the alt attribute’s value is `foo bar`, not `foo [bar](https://github.github.com/url)` or `foo <a href="/url">bar</a>`. Only the plain string content is rendered, without formatting.
...
```
My ![foo bar](https://github.github.com/path/to/train.jpg  "title"   )
